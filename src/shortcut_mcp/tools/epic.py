...
def register(server: FastMCP) -> None:
    ...
    async def shortcut_list_epics(ctx: Context, limit: LimitParam = 50) -> dict[str, Any]:
    ...
    async def shortcut_get_epic(ctx: Context, epic_id: int) -> dict[str, Any]:
        return await get_object(ctx, f"/epics/{_seg(str(epic_id))}")
    ...
    async def shortcut_list_epic_stories(ctx: Context, epic_id: int, limit: LimitParam = 50) -> dict[str, Any]:
