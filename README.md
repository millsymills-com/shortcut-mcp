...
| `SHORTCUT_LOG_LEVEL` | `INFO` | Log level for structured JSON stderr logging |

These may be set in the process environment or supplied via a `.env` file in the
working directory, which the server loads on startup.
